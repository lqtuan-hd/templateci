...
class AppController extends BaseController
{
	...
	public function show_calendar(){
		$data = [
			...
			'page_title' => view('partials/page-title', ['title' => 'Calendar', 'pagetitle' => 'Skote'])
		];
	...
	public function show_crypto_wallet(){
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Wallets']),
			'page_title' => view('partials/page-title', ['title' => 'Wallets', 'pagetitle' => 'Crypto'])
		];
